...
<html lang="en">
    <head>
        ...
        <script src="application/js/data_from_sqlite.js"></script>
    ...
    <body id="bodyColor">
        ...
        <nav>
            <div class="logo">
                <h1 id="title1" <?php echo "<h1>" . $data[0]['content'] . "</h1>"; ?>></h1>
                <h2 id="title2" <?php echo "<h2>" . $data[1]['content'] . "</h2>"; ?>></h2>
                <h3 id="title3">Choice</h3>
                <h4 id="title4">Bold</h4>
                <h5 id="title5">Taste</h5>
            </div>
        </nav>
        <!-- Navigation bar -->
        ...
        <div class="container" id="mainContainer">
            ...
            <div id="home" class="mainContent" style="display: block;">
                ...
                <div class="row" id="mainLogos">
                    <div class="col-sm-4" id="fantaImage"> 
                        <img onclick="popup('fantaInfo')" src="application/assets/images/fanta.jpg" style="width:99%" />
                    </div>
                    <div class="col-sm-4" id="zeroImage">
                        <img onclick="popup('zeroInfo')" src="application/assets/images/zero.jpg" style="width:98%" />
                    </div>
                    <div class="col-sm-4" id="cokeImage">
                        <img onclick="popup('cokeInfo')" src="application/assets/images/coca_cola.jpg" style="width:99%" />
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12" id="fantaInfo" style="display: none;">
                        <p id="fantaPara">fanta description</p>
                        <img src="application/assets/images/" style="width:100%" />
                        <a id="fantaRef" href="https://www.coca-cola.co.uk/brands/fanta">Click to find out more about Fanta</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12" id="zeroInfo" style="display: none;">
                        <p id="zeroPara">coke zero description</p>
                        <img src="application/assets/images/" style="width:100%" />
                        <a id="zeroRef" href="https://www.coca-cola.co.uk/brands/coca-cola-zero-sugar">Click to find out more about Coke Zero</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12" id="cokeInfo" style="display: none;">
                        <p id="cokePara">coke description</p>
                        <img src="application/assets/images/" style="width:100%" />
                        <a id="cokeRef" href="https://www.coca-cola.co.uk/brands/coca-cola-original-taste">Click to find out more about Coke </a>
                    </div>
                </div>
            </div>
            <!-- About -->
            <div id="about" style="display: none;">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <iframe width="700" height="700" src="https://www.youtube.com/embed/aEJt_j0Ilqc" frameborder="0" allowfullscreen></iframe>
                    </div>
                    <div class="col-sm-6">
                        <p id="fantaVideo"></p>
                    </div>
