...
<html lang="en">
  <head>
    ...
    <script src="https://kit.fontawesome.com/b56386814c.js" crossorigin="anonymous"></script>
    <!-- Fontawesome CSS -->
  ...
  <body id="bodyColor">
                  ...
                  <div class="card text-left">
                      ...
                      <div id="sprite" style="display:none;">
                          ...
                          <div class="model3D">
                              <x3d id="model">
                                  <scene>
                                      <inline nameSpaceName="model" mapDEFToID="true" onclick="animateModel();" url="#"> </inline>
                                  </scene>
                              </x3d>
                          </div> 
    ...
    <!--<script src="webfonts/all.js"></script> -->
